...
#COPY ~/workspace/CI/target/java-tomcat-maven-example.war /etc/apache-tomcat/webapps/
COPY /var/lib/jenkins/workspace/CI/target/java-tomcat-maven-example.war /etc/apache-tomcat/webapps/
EXPOSE 8080
